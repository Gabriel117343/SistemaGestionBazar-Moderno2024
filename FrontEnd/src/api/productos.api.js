...
export const getAllProductos = ({ incluir_inactivos, page, orden, page_size, filtro, categoria, seccion }, signal) => {
  ...
  return productosApi.get('/', {
    ...
    // se envia el signal para abortar la peticion en curso
    signal: signal
