...
const MostrarPedidos = forwardRef(
  (
    ...
    const { stateStock: { stocks },
      recibirStockContext, getStocksContext
                    ...
                    <td>
                      {pedido?.estado === "pendiente" ? (
                        ...
                        <p
                          ...
                          className="p-1 m-0 text-white bg-success d-flex align-items-center mt-1 justify-content-center"
                        >
                          Recibidio
                        </p>
                      )}
...
export const ValidarPedidos = forwardRef(
  ({ pedidos }, ref) => {
    const validacion = pedidos.length != 1;
