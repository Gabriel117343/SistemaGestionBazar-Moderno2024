...
import { toast } from 'react-hot-toast' // esto es para los toast
import { useNavigate } from 'react-router-dom' // hook para navegar entre paginas
import debounce from 'lodash/debounce' // para evitar multiples peticiones al servidor
      ...
      <div className="container py-5" style={{height: '110vh'}}>
        <div className="row d-flex justify-content-center align-items-center">
          <div className="col-12 col-md-8 col-lg-6 col-xl-5">
            <div className="card bg-dark text-white efecto-login" style={{ borderRadius: '1rem' }}>
              <div className="card-body px-4 pb-4 text-center">
                ...
                <div>
                  ...
                  <div className='mb-3'>
                    <img style={{width:'100%'}} src="../public/images/login-imagen.png" alt="" />
